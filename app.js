...
function renderToDOM(){
  ...
  for(i = 0; i < 3; i++ ){ // Raises show prperty of productDisplayed productsArray by 1. 
    var index = productDisplayQue[i];
    var item = productsArray[index];
...
// on load - get localstorage products
  // if there - use them to create Products otherwise, create new objects like below
  // make sure to save to array with products!!!
